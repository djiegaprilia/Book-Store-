...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String database_name = "db_pesan";
    public static final String tabel_name = "tb_pesan";
    ...
    public static final String row_beli = "TglBeli";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + tabel_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nama + " TEXT," + row_judul + " TEXT," + row_harga + " TEXT," + row_jumlah + " TEXT," + row_alamat + " TEXT," + row_beli + " TEXT,"+ row_status + " TEXT)";
        db.execSQL(query);
    }
