package com.djiega.projek.database;
...
public class SqliteDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_PRODUCTS_TABLE = "CREATE TABLE " + TABLE_PRODUCTS + "(" + COLUMN_ID
                + " INTEGER PRIMARY KEY," + COLUMN_PRODUCTNAME + " TEXT," + COLUMN_TITLE + " TEXT,"+
                COLUMN_HARGA + " INTEGER," +COLUMN_ALAMAT + " TEXT," + COLUMN_QUANTITY + " INTEGER)";
    ...
    public List<Product> listProducts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int harga = Integer.parseInt(cursor.getString(3));
                String alamat = cursor.getString(4);
                int quantity = Integer.parseInt(cursor.getString(5));
                storeProducts.add(new Product(id, name,title,harga,alamat,quantity));
    ...
    public void addProduct(Product product){
        ...
        values.put(COLUMN_TITLE, product.getJudul());
        values.put(COLUMN_HARGA, product.getHarga());
        values.put(COLUMN_ALAMAT, product.getAlamat());
    ...
    public void updateProduct(Product product) {
        ...
        public Product findProduct(String name){
            ...
            if(cursor.moveToFirst()){
                ...
                int harga =  Integer.parseInt(cursor.getString(3));
                String alamat =  cursor.getString(4);
                int productQuantity = Integer.parseInt(cursor.getString(5));
                mProduct = new Product(id, productName, judul, harga ,alamat, productQuantity);
            }
            cursor.close();
            return mProduct;
        }
